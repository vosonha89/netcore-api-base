...
/// <summary>
/// Represents a Data Transfer Object (DTO) for product response data.
/// This class is used for encapsulating and transferring product-related information
/// in the API responses, adhering to the given structure and constraints.
/// It inherits from the BaseItemResponse with specific source and identifier types.
/// </summary>
public class ProductResponseDto: BaseItemResponse<Infrastructure.Persistence.Entities.Product, long>
{
    [MaxLength(4000)]
    ...
    [MaxLength(4000)]
    public string? MetaBarcode { get; init; }
